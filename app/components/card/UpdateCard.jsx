...
export default function UpdateCard({ id, cardHolder, phone, cardNumber, active }) {
    ...
    return (
        <form onSubmit={handleSubmit} className='container flex flex-col gap-y-5 w-[800px]'>
            ...
            <Input type="text" name='cardNumber' defaultValue={cardNumber} placeholder='Номер карты' />
            <Input type="text" name='phone' defaultValue={phone} placeholder='Номер телефона' />
